...
# --- BRANDING: MODERN SAAS AESTHETIC (Restored) ---
...
st.markdown(f"""
    <style>
    /* --- SIDEBAR FIX START --- */
    /* This brings back the arrow but keeps the header transparent */
    header {{
        visibility: visible !important;
        background: transparent !important;
    }}
    /* We only hide the hamburger menu and footer specifically */
